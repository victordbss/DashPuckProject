...
MOTOR_SPEED_TO_SENSOR = 50 # Vitesse du moteur qui tient le bras jusqu'au capteur (étape1)
...
STOP_SERVO_START_ANGLE = 0 # Angle du servo moteur bloqueur pour lequel il ne stoppe pas le chemin du bras robotique
STOP_SERVO_END_ANGLE = 90 # Angle du servo moteur bloqueur pour lequel il stoppe le bras robotique